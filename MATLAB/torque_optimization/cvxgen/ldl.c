...
void fill_KKT(void) {
  work.KKT[51] = params.P[0];
  work.KKT[52] = params.P[4];
  work.KKT[53] = params.P[8];
  work.KKT[54] = params.P[12];
  work.KKT[56] = params.P[5];
  work.KKT[57] = params.P[9];
  work.KKT[58] = params.P[13];
  work.KKT[60] = params.P[10];
  work.KKT[61] = params.P[14];
  work.KKT[63] = params.P[15];
  ...
  work.KKT[20] = -params.A[12];
  work.KKT[22] = -params.A[1];
  work.KKT[23] = -params.A[5];
  work.KKT[24] = -params.A[9];
  work.KKT[25] = -params.A[13];
  work.KKT[27] = -params.A[2];
  work.KKT[28] = -params.A[6];
  work.KKT[29] = -params.A[10];
  work.KKT[30] = -params.A[14];
  work.KKT[32] = -params.A[3];
  work.KKT[33] = -params.A[7];
  work.KKT[34] = -params.A[11];
  work.KKT[35] = -params.A[15];
  work.KKT[37] = params.A[0];
  work.KKT[38] = params.A[4];
  work.KKT[39] = params.A[8];
  work.KKT[40] = params.A[12];
  work.KKT[42] = params.A[1];
  work.KKT[43] = params.A[5];
  work.KKT[44] = params.A[9];
  work.KKT[45] = params.A[13];
  work.KKT[47] = params.A[2];
  work.KKT[48] = params.A[6];
  work.KKT[49] = params.A[10];
  work.KKT[50] = params.A[14];
  work.KKT[55] = params.A[3];
  work.KKT[59] = params.A[7];
  work.KKT[62] = params.A[11];
  work.KKT[64] = params.A[15];
}
